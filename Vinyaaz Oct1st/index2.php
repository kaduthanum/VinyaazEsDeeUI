...
<div class="left_tiles">
    ...
    <ul class="og-grid">
        <li>
            ...
            <a href="differentiators2.php" data-largesrc="images/dummy/new/2.jpg" data-title="Catalogue Creation Explained!" 
        ...
        <li>
            ...
            <a href="differentiators2.php" data-largesrc="images/dummy/new/2.jpg" data-title="Mobile & Tablet App" data-description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent adipiscing viverra volutpat dolor sit amet. consectetur adipiscing elit praesent adipiscing.">
                <div class="differentiator">
        ...
        <li>
            ...
            <a href="differentiators2.php" data-largesrc="images/dummy/new/1.jpg" data-title="100s of Stunning Designs" data-description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent adipiscing viverra volutpat dolor sit amet. consectetur adipiscing elit praesent adipiscing.">
        ...
        <li>
            ...
            <a href="differentiators2.php" data-largesrc="images/dummy/new/1.jpg" data-title="Analytics" data-description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent adipiscing viverra volutpat dolor sit amet. consectetur adipiscing elit praesent adipiscing.">
                <div class="differentiator noright_border">
                    <h3>Analytics</h3>
                    <h4>Just for you</h4>
                </div>
...
<div class="right_content">
    <div class="top_images">        
        <object classid='clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B' class="embedvideo"
            ...
            <embed src="media/intro.mov" class="embedvideo"
    ...
    <div class="clr separation_thick nonIpad"></div>

    <!-- 6 key differentiators -->
    <ul id="og-grid" class="og-grid nonIpad">
        <li>
            <span class="numbers">1</span>
            <a href="differentiators2.php" data-largesrc="images/dummy/new/2.jpg" data-title="Catalogue Creation Explained!" 
            data-description="Welcome to Vinyaaz! You are just a few minutes from treating your own Stunning catalogs ! 5 simple steps<br>
